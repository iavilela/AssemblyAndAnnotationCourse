...
dat <- fread("/home/ianis/Documents/GenespaceTest/orthofinder/Results_Dec07/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv")
ids=names(dat)
...
p <- ggplot(o_ratio, aes(x =  V1, y = perc, fill = species)) +
  ...
  labs(y = "Count")
ggsave("/home/ianis/Documents/Uni/5. Semester/Genome Annotation/Output Files/orthogroup_number_plot.pdf")
...
p <- ggplot(o_percent, aes(x =  V1, y = perc, fill = species)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(y = "Count")
ggsave("/home/ianis/Documents/Uni/5. Semester/Genome Annotation/Output Files/orthogroup_percentage_plot.pdf")
...
ogroups <- fread("/home/ianis/Documents/Genespace/orthofinder/Results_Dec07/Orthogroups/Orthogroups.GeneCount.tsv")
